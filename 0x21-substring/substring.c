 ...
 * @len: length of array
 * @q: value to be checked
 * Return: 1 if value not found, otherwise 0
 */
 ...
 * Return: 1 if word is a substring of str, otherwise 0
 */
 ...
 * Return: 1 if a full match of a substring made of 'words' exists, otherwise
 */
